...
export const TaskDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterReactPostgresAppApp.task.delete.question">
        <Translate contentKey="jhipsterReactPostgresAppApp.task.delete.question" interpolate={{ id: taskEntity.id }}>
