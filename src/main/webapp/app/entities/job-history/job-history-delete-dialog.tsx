...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterReactPostgresAppApp.jobHistory.delete.question">
        <Translate contentKey="jhipsterReactPostgresAppApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
