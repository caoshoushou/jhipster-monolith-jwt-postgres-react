...
export const JobDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterReactPostgresAppApp.job.delete.question">
        <Translate contentKey="jhipsterReactPostgresAppApp.job.delete.question" interpolate={{ id: jobEntity.id }}>
